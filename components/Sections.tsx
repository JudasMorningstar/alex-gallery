          ...
          <div className="gap-8 py-8 px-4 mx-auto object-contain max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <Link
                ...
                key={picture._id}
                className="text-gray-50 rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-slate-50 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                visit gallery
              </Link>
            </div>
